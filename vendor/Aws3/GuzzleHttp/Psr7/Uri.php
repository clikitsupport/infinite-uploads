...
use ClikIT\Infinite_Uploads\GuzzleHttp\Psr7\Exception\MalformedUriException;
...
class Uri implements UriInterface, \JsonSerializable
{
     ...
     * `ClikIT\Infinite_Uploads\Psr\Http\Message\UriInterface::__toString`.
     *
     ...
     *
     * `ClikIT\Infinite_Uploads\Psr\Http\Message\UriInterface::getPort` may return null or the standard port. This method can be used
