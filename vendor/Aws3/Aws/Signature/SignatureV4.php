...
use ClikIT\Infinite_Uploads\AWS\CRT\Auth\Signable;
use ClikIT\Infinite_Uploads\AWS\CRT\Auth\SignatureType;
use ClikIT\Infinite_Uploads\AWS\CRT\Auth\SignedBodyHeaderType;
use ClikIT\Infinite_Uploads\AWS\CRT\Auth\Signing;
use ClikIT\Infinite_Uploads\AWS\CRT\Auth\SigningAlgorithm;
use ClikIT\Infinite_Uploads\AWS\CRT\Auth\SigningConfigAWS;
use ClikIT\Infinite_Uploads\AWS\CRT\Auth\StaticCredentialsProvider;
use ClikIT\Infinite_Uploads\AWS\CRT\HTTP\Request;
use ClikIT\Infinite_Uploads\Aws\Exception\CommonRuntimeException;
...
{
    use SignatureTrait;
    const ISO8601_BASIC = 'ClikIT\Infinite_Uploads\Ymd\THis\Z';
