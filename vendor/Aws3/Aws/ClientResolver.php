...
use ClikIT\Infinite_Uploads\Aws\Auth\AuthSchemeResolver;
use ClikIT\Infinite_Uploads\Aws\Auth\AuthSchemeResolverInterface;
use ClikIT\Infinite_Uploads\Aws\ClientSideMonitoring\ApiCallAttemptMonitoringMiddleware;
use ClikIT\Infinite_Uploads\Aws\ClientSideMonitoring\ApiCallMonitoringMiddleware;
use ClikIT\Infinite_Uploads\Aws\ClientSideMonitoring\Configuration;
...
use ClikIT\Infinite_Uploads\Aws\Endpoint\UseDualstackEndpoint\Configuration as UseDualStackEndpointConfiguration;
use ClikIT\Infinite_Uploads\Aws\Endpoint\UseDualstackEndpoint\ConfigurationInterface as UseDualStackEndpointConfigurationInterface;
use ClikIT\Infinite_Uploads\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider as UseDualStackConfigProvider;
use ClikIT\Infinite_Uploads\Aws\Endpoint\UseFipsEndpoint\Configuration as UseFipsEndpointConfiguration;
use ClikIT\Infinite_Uploads\Aws\Endpoint\UseFipsEndpoint\ConfigurationInterface as UseFipsEndpointConfigurationInterface;
use ClikIT\Infinite_Uploads\Aws\Endpoint\UseFipsEndpoint\ConfigurationProvider as UseFipsConfigProvider;
use ClikIT\Infinite_Uploads\Aws\EndpointDiscovery\ConfigurationInterface;
...
use ClikIT\Infinite_Uploads\Aws\Retry\ConfigurationInterface as RetryConfigInterface;
use ClikIT\Infinite_Uploads\Aws\Retry\ConfigurationProvider as RetryConfigProvider;
use ClikIT\Infinite_Uploads\Aws\Signature\SignatureProvider;
use ClikIT\Infinite_Uploads\Aws\Token\Token;
use ClikIT\Infinite_Uploads\Aws\Token\TokenInterface;
use ClikIT\Infinite_Uploads\Aws\Token\TokenProvider;
...
class ClientResolver
{
    ...
    private static $defaultArgs = [
        ...
        'configuration_mode' => [
            ...
            'doc'     => "Sets the default configuration mode. Otherwise provide an instance of ClikIT\Infinite_Uploads\Aws\DefaultsMode\ConfigurationInterface, an instance of  ClikIT\Infinite_Uploads\Aws\CacheInterface, or a string containing a valid mode",
        ...
        'credentials' => [
            ...
            'doc'     => 'Specifies the credentials used to sign requests. Provide an ClikIT\Infinite_Uploads\Aws\Credentials\CredentialsInterface object, an associative array of "key", "secret", and an optional "token" key, `false` to use null credentials, or a callable credentials provider used to create credentials or return null. See Aws\\Credentials\\CredentialProvider for a list of built-in credentials providers. If no credentials are provided, the SDK will attempt to load them from the environment.',
        ...
        'token' => [
            ...
            'doc'     => 'Specifies the token used to authorize requests. Provide an ClikIT\Infinite_Uploads\Aws\Token\TokenInterface object, an associative array of "token", and an optional "expiration" key, `false` to use a null token, or a callable token provider used to fetch a token or return null. See Aws\\Token\\TokenProvider for a list of built-in credentials providers. If no token is provided, the SDK will attempt to load one from the environment.',
        ...
        'auth_scheme_resolver' => [
            ...
            'doc'     => 'An instance of ClikIT\Infinite_Uploads\Aws\Auth\AuthSchemeResolverInterface which selects a modeled auth scheme and returns a signature version',
            'default' => [__CLASS__, '_default_auth_scheme_resolver'],
        ],
        'endpoint_discovery' => [
            'type'     => 'value',
            'valid'    => [ConfigurationInterface::class, CacheInterface::class, 'array', 'callable'],
            'doc'      => 'Specifies settings for endpoint discovery. Provide an instance of ClikIT\Infinite_Uploads\Aws\EndpointDiscovery\ConfigurationInterface, an instance ClikIT\Infinite_Uploads\Aws\CacheInterface, a callable that provides a promise for a Configuration object, or an associative array with the following keys: enabled: (bool) Set to true to enable endpoint discovery, false to explicitly disable it. Defaults to false; cache_limit: (int) The maximum number of keys in the endpoints cache. Defaults to 1000.',
        ...
        'stats' => [
            ...
            'valid' => ['bool', 'array'],
            'default' => false,
            'doc'   => 'Set to true to gather transfer statistics on requests sent. Alternatively, you can provide an associative array with the following keys: retries: (bool) Set to false to disable reporting on retries attempted; http: (bool) Set to true to enable collecting statistics from lower level HTTP adapters (e.g., values returned in ClikIT\Infinite_Uploads\GuzzleHttp\TransferStats). HTTP handlers must support an http_stats_receiver option for this to have an effect; timer: (bool) Set to true to enable a command timer that reports the total wall clock time spent on an operation in seconds.',
            'fn'    => [__CLASS__, '_apply_stats'],
        ],
        'retries' => [
            'type'    => 'value',
            'valid'   => ['int', RetryConfigInterface::class, CacheInterface::class, 'callable', 'array'],
            'doc'     => "Configures the retry mode and maximum number of allowed retries for a client (pass 0 to disable retries). Provide an integer for 'legacy' mode with the specified number of retries. Otherwise provide an instance of Aws\Retry\ConfigurationInterface, an instance of  ClikIT\Infinite_Uploads\Aws\CacheInterface, a callable function, or an array with the following keys: mode: (string) Set to 'legacy', 'standard' (uses retry quota management), or 'adapative' (an experimental mode that adds client-side rate limiting to standard mode); max_attempts: (int) The maximum number of attempts for a given request. ",
        ...
        'csm' => [
            'type'     => 'value',
            'valid'    => [\ClikIT\Infinite_Uploads\Aws\ClientSideMonitoring\ConfigurationInterface::class, 'callable', 'array', 'bool'],
            ...
            'default'  => [\ClikIT\Infinite_Uploads\Aws\ClientSideMonitoring\ConfigurationProvider::class, 'defaultProvider']
        ],
        'http' => [
            'type'    => 'value',
            'valid'   => ['array'],
        ...
        'handler' => [
            'type'     => 'value',
            'valid'    => ['callable'],
            'doc'      => 'A handler that accepts a command object, request object and returns a promise that is fulfilled with an ClikIT\Infinite_Uploads\Aws\ResultInterface object or rejected with an ClikIT\Infinite_Uploads\Aws\Exception\AwsException. A handler does not accept a next handler as it is terminal and expected to fulfill a command. If no handler is provided, a default Guzzle handler will be utilized.',
     ...
     * @see ClikIT\Infinite_Uploads\Aws\AwsClient::__construct for a list of available options.
     */
    ...
    public static function _apply_csm($value, array &$args, HandlerList $list)
    {
        if ($value === false) {
            $value = new Configuration(
                false,
                \ClikIT\Infinite_Uploads\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_HOST,
                \ClikIT\Infinite_Uploads\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_PORT,
                \ClikIT\Infinite_Uploads\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_CLIENT_ID
            );
            $args['csm'] = $value;
        }
    ...
    public static function _apply_endpoint_provider($value, array &$args)
    {
        if (!isset($args['endpoint'])) {
            if ($value instanceof \ClikIT\Infinite_Uploads\Aws\EndpointV2\EndpointProviderV2) {
    ...
    public static function _default_endpoint_provider(array $args)
    {
        ...
        if (self::isValidService($serviceName)
            ...
            return new \ClikIT\Infinite_Uploads\Aws\EndpointV2\EndpointProviderV2(
                $ruleset,
    ...
    public static function _apply_suppress_php_deprecation_warning($value, &$args)
    {
        if ($value)  {
            ...
            $args['suppress_php_deprecation_warning']
                = \ClikIT\Infinite_Uploads\Aws\boolean_value(getenv("AWS_SUPPRESS_PHP_DEPRECATION_WARNING"));
        } elseif (!empty($_SERVER["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"])) {
            $args['suppress_php_deprecation_warning'] =
                \ClikIT\Infinite_Uploads\Aws\boolean_value($_SERVER["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"]);
        } elseif (!empty($_ENV["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"])) {
            $args['suppress_php_deprecation_warning'] =
                \ClikIT\Infinite_Uploads\Aws\boolean_value($_ENV["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"]);
        }
    ...
    public static function _default_endpoint(array &$args)
    {
        ...
        $serviceIdentifier = \ClikIT\Infinite_Uploads\Aws\manifest($args['service'])['serviceIdentifier'];
...
EOT;
    ...
    private static function isValidService($service)
    {
        ...
        $services = \ClikIT\Infinite_Uploads\Aws\manifest();
