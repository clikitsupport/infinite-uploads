...
use ClikIT\Infinite_Uploads\Aws\S3\Crypto\S3EncryptionClientV3;
enum AlgorithmSuite : int
{
    ...
    {
        return match ($this) {
            self::ALG_AES_256_CBC_IV16_NO_KDF => \true,
            default => \false,
        };
    }
    ...
    {
        return match ($this) {
            self::ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY => \true,
            default => \false,
        };
    }
    ...
    {
        return match ($this) {
            self::ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY, self::ALG_AES_256_GCM_IV12_TAG16_NO_KDF => AlgorithmConstants::GCM_MAX_CONTENT_LENGTH_BITS,
