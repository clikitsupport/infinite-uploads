...
class MetadataEnvelope implements ArrayAccess, IteratorAggregate, JsonSerializable
{
    ...
    public static function isV3Envelope(MetadataEnvelope $envelope): bool
    {
        ...
        if (!isset($envelope[MetadataEnvelope::ENCRYPTED_DATA_KEY_V3]) || !isset($envelope[MetadataEnvelope::CONTENT_CIPHER_V3]) || !isset($envelope[MetadataEnvelope::KEY_COMMITMENT_V3]) || !isset($envelope[MetadataEnvelope::MESSAGE_ID_V3]) || !isset($envelope[MetadataEnvelope::ENCRYPTED_DATA_KEY_ALGORITHM_V3]) || !isset($envelope[MetadataEnvelope::ENCRYPTION_CONTEXT_V3])) {
            return \false;
        }
        return \true;
    }
    ...
    {
        return [MetadataEnvelope::CONTENT_KEY_V2_HEADER, MetadataEnvelope::MATERIALS_DESCRIPTION_HEADER, MetadataEnvelope::IV_HEADER, MetadataEnvelope::KEY_WRAP_ALGORITHM_HEADER, MetadataEnvelope::CONTENT_CRYPTO_SCHEME_HEADER, MetadataEnvelope::CRYPTO_TAG_LENGTH_HEADER];
    }
    public static function getV3Fields(): array
    {
        return [MetadataEnvelope::ENCRYPTED_DATA_KEY_V3, MetadataEnvelope::CONTENT_CIPHER_V3, MetadataEnvelope::KEY_COMMITMENT_V3, MetadataEnvelope::MESSAGE_ID_V3, MetadataEnvelope::ENCRYPTED_DATA_KEY_ALGORITHM_V3, MetadataEnvelope::ENCRYPTION_CONTEXT_V3];
    }
}
