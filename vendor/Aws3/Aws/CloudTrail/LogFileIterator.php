...
use ClikIT\Infinite_Uploads\Aws\CloudTrail\Exception\CloudTrailException;

/**
 * The `ClikIT\Infinite_Uploads\Aws\CloudTrail\LogFileIterator` provides an easy way to iterate over
