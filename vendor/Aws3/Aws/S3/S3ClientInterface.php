...
interface S3ClientInterface extends AwsClientInterface
{
     ...
     * @param array  $options ClikIT\Infinite_Uploads\Aws\S3\BatchDelete options array.
     *
     * @see ClikIT\Infinite_Uploads\Aws\S3\S3Client::listObjects
     ...
     *
     * @see ClikIT\Infinite_Uploads\Aws\S3\MultipartUploader for more info about multipart uploads.
     ...
     * @param array  $options       Options used to configure the upload process.
     *
     * @see ClikIT\Infinite_Uploads\Aws\S3\MultipartCopy for more info about multipart uploads.
     ...
     * @param array  $options   Options available in ClikIT\Infinite_Uploads\Aws\S3\Transfer::__construct
     *
     * @see ClikIT\Infinite_Uploads\Aws\S3\Transfer for more options and customization
     */
