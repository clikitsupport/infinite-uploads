...
use ClikIT\Infinite_Uploads\Aws\Identity\S3\S3ExpressIdentityProvider;
use ClikIT\Infinite_Uploads\Aws\InputValidationMiddleware;
use ClikIT\Infinite_Uploads\Aws\Middleware;
use ClikIT\Infinite_Uploads\Aws\ResultInterface;
use ClikIT\Infinite_Uploads\Aws\Retry\QuotaManager;
use ClikIT\Infinite_Uploads\Aws\RetryMiddleware;
use ClikIT\Infinite_Uploads\Aws\RetryMiddlewareV2;
use ClikIT\Infinite_Uploads\Aws\S3\Parser\GetBucketLocationResultMutator;
use ClikIT\Infinite_Uploads\Aws\S3\Parser\S3Parser;
use ClikIT\Infinite_Uploads\Aws\S3\Parser\ValidateResponseChecksumResultMutator;
...
class S3Client extends AwsClient implements S3ClientInterface
{
     ...
     * {@see ClikIT\Infinite_Uploads\Aws\AwsClient::__construct}, S3Client accepts the following
     * options:
     *
     ...
     *   (ClikIT\Infinite_Uploads\Aws\S3\RegionalEndpoint\ConfigurationInterface|ClikIT\Infinite_Uploads\Aws\CacheInterface\|callable|string|array)
     *   Specifies whether to use regional or legacy endpoints for the us-east-1
     *   region. Provide an ClikIT\Infinite_Uploads\Aws\S3\RegionalEndpoint\ConfigurationInterface object, an
     ...
     * - use_arn_region: (ClikIT\Infinite_Uploads\Aws\S3\UseArnRegion\ConfigurationInterface,
     *   ClikIT\Infinite_Uploads\Aws\CacheInterface, bool, callable) Set to true to enable the client
     *   to use the region from a supplied ARN argument instead of the client's
     *   region. Provide an instance of ClikIT\Infinite_Uploads\Aws\S3\UseArnRegion\ConfigurationInterface,
     *   an instance of ClikIT\Infinite_Uploads\Aws\CacheInterface, a callable that provides a promise for
    ...
    public function createPresignedRequest(CommandInterface $command, $expires, array $options = [])
    {
        ...
        /** @var \ClikIT\Infinite_Uploads\Aws\Signature\SignatureInterface $signer */
     ...
     * use the {@see ClikIT\Infinite_Uploads\Aws\S3\S3Client::createPresignedRequest} method and get
    ...
    public static function applyDocFilters(array $api, array $docs)
    {
        ...
        $guzzleStreamMessage = "<p>Additional info on behavior of the stream"
            ...
            . " <code>ClikIT\Infinite_Uploads\Psr\Http\Message\StreamInterface</code>, and it will be returned"
    ...
    public static function addDocExamples($examples)
    {
        $getObjectExample = [
            ...
            'output' => [
                'Body' => 'class ClikIT\Infinite_Uploads\GuzzleHttp\Psr7\Stream#208 (7) {...}',
                'ContentLength' => '11',
