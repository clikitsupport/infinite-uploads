...
class InfiniteUploadsVideo {
    ...
    function admin_scripts() {
        wp_enqueue_script( 'iup-admin', plugins_url( 'build/admin.js', __DIR__ ), array(
                'wp-element',
                'wp-i18n',
        ), ( wp_get_environment_type() !== 'production' ? time() : INFINITE_UPLOADS_VERSION ), false );
    }
    ...
    function video_library_page2() {
        ...
        <div id="container" class="wrap iup-background">
            ...
            <h1 class="text-muted mb-3">
                <img src="<?php
                echo esc_url( plugins_url( '/assets/img/iu-logo-gray.svg', __FILE__ ) ); ?>" alt="Infinite Uploads Logo"
                     height="36" width="36"/>
                <?php
                esc_html_e( 'Video Library', 'infinite-uploads' ); ?>
            </h1>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="upload-modal-label"><?php
                            esc_html_e( 'Upload Video', 'infinite-uploads' ); ?></h5>
                        ...
                        <div class="container-fluid">
                            <div class="row justify-content-center mb-4 mt-3">
                                <div class="col text-center">
                                    <h4><?php
                                        esc_html_e( 'Add a New Video to the Infinite Uploads Cloud', 'infinite-uploads' ); ?></h4>
                                    <p class="lead"><?php
                                        esc_html_e( 'Drop your videos here to upload them to your cloud video library for encoding and embedding on your site.', 'infinite-uploads' ); ?></p>

                                    <img class="mb-4" src="<?php
                                    echo esc_url( plugins_url( '/inc/assets/img/push-to-cloud.svg', dirname( __FILE__ ) ) ); ?>"
                                         alt="Upload to Cloud" height="76" width="76"/>
