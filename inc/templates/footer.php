<div id="iup-footer" class="container mt-5">
	...
	<div class="row mt-3">
		<div class="col-sm text-center text-muted">
			<a href="<?php echo esc_url( InfiniteUploadsAdmin::get_instance()->api_url( '/support/?utm_source=iup_plugin&utm_medium=plugin&utm_campaign=iup_plugin&utm_content=footer&utm_term=support' ) ); ?>"
			   class="text-muted text-decoration-none"><?php esc_html_e( "Support", 'infinite-uploads' ); ?></a> |
			<a href="<?php echo esc_url( InfiniteUploadsAdmin::get_instance()->api_url( '/terms-of-service/?utm_source=iup_plugin&utm_medium=plugin&utm_campaign=iup_plugin&utm_content=footer&utm_term=terms' ) ); ?>"
			   class="text-muted text-decoration-none"><?php esc_html_e( "Terms of Service", 'infinite-uploads' ); ?></a> |
			<a href="<?php echo esc_url( InfiniteUploadsAdmin::get_instance()->api_url( '/privacy/?utm_source=iup_plugin&utm_medium=plugin&utm_campaign=iup_plugin&utm_content=footer&utm_term=privacy' ) ); ?>"
